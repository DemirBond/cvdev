                ...
                add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.ECHOCARDIOGRAPHY, context.getString(R.string.echocardiography), false, new ArrayList<EvaluationItem>() {
                    {
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.ENLARGED_LA_OR_LVH, context.getString(R.string.enlarged_la_or_lvh), false));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.HEPATIC_VEIN_EXP_DIASTOLIC_REVERSAL, context.getString(R.string.hepatic_vein_exp_diastolic_reversal), false));
